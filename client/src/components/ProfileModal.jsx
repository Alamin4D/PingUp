            ...
            <div className='max-w-2xl sm:py-6 mx-auto'>
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form onSubmit={handleSaveProfile} className='space-y-4'>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>Profile Picture
                                ...
                                <div className='group/profile relative'>
                                    <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="" className='w-24 h-24 rounded-full object-center mt-2' />
                        ...
                        {/* Cover Photo */}
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="cover_photo" className='block tex-sm font-medium text-gray-700 mb-1'>
                                Cover Photo
